(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_7e50ede1._.js", {
...
function CreateVoteForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const tx = await contract.createProposalBasedCampaign(formData.description, parseInt(formData.restriction), parseInt(formData.resultType), startTimestamp, endTimestamp, maxVoters, formData.proposals.filter((p)=>p.trim().length > 0));
...
//# sourceMappingURL=_7e50ede1._.js.map