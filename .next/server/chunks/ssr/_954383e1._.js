...
function CreateVoteForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // Here you would connect to the contract and call createProposalBasedCampaign
    ...
    const minStartTimeStr = format(minStartTime, "yyyy-MM-dd'T'HH:mm");
    // If start time is set, end time must be after it
    const minEndTimeStr = formData.startTime ? format(new Date(new Date(formData.startTime).getTime() + 60000), "yyyy-MM-dd'T'HH:mm") : minStartTimeStr;
...
//# sourceMappingURL=_954383e1._.js.map